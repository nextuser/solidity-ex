...
library Strings {
   ...
   function sliceToString( bytes calldata arr , uint start ) pure public returns (string memory){
        return string(arr[start:]);
    }


   function toString(uint256  _num )  public view returns (string memory){
